...
class testMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.thing != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      final temp = this.thing;
      oprot.writeMapBegin(thrift.TMap(thrift.TType.I32, thrift.TType.I32, temp.length));
      for(var elem11 in temp.keys) {
        oprot.writeI32(elem11);
        oprot.writeI32(temp[elem11]);
      }
      oprot.writeMapEnd();
      oprot.writeFieldEnd();
    }
...
class testStringMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.thing != null) {
      ...
      for(var elem17 in temp.keys) {
        oprot.writeString(elem17);
        oprot.writeString(temp[elem17]);
      }
      oprot.writeMapEnd();
      oprot.writeFieldEnd();
    }
...
class testSet_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.thing != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      final temp = this.thing;
      oprot.writeSetBegin(thrift.TSet(thrift.TType.I32, temp.length));
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            thrift.TMap elem33 = iprot.readMapBegin();
            final elem40 = <int, Map<int, int>>{};
            for(int elem39 = 0; elem39 < elem33.length; ++elem39) {
              int elem41 = iprot.readI32();
              thrift.TMap elem35 = iprot.readMapBegin();
              final elem34 = <int, int>{};
              for(int elem37 = 0; elem37 < elem35.length; ++elem37) {
                int elem38 = iprot.readI32();
                int elem36 = iprot.readI32();
                elem34[elem38] = elem36;
              }
              iprot.readMapEnd();
              elem40[elem41] = elem34;
            }
            iprot.readMapEnd();
            this.success = elem40;
          } else {
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            ...
            final elem49 = <int, Map<int, t_frugal_test.Insanity>>{};
            for(int elem48 = 0; elem48 < elem42.length; ++elem48) {
              int elem50 = iprot.readI64();
              thrift.TMap elem44 = iprot.readMapBegin();
              final elem43 = <int, t_frugal_test.Insanity>{};
              for(int elem46 = 0; elem46 < elem44.length; ++elem46) {
                int elem47 = t_frugal_test.deserializeNumberz(iprot.readI32());
                t_frugal_test.Insanity elem45 = t_frugal_test.Insanity();
                elem45.read(iprot);
                elem43[elem47] = elem45;
              }
              iprot.readMapEnd();
              elem49[elem50] = elem43;
            }
            iprot.readMapEnd();
            this.success = elem49;
          } else {
...
class testMulti_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.arg3 != null) {
      ...
      final temp = this.arg3;
      oprot.writeMapBegin(thrift.TMap(thrift.TType.I16, thrift.TType.STRING, temp.length));
      for(var elem51 in temp.keys) {
        oprot.writeI16(elem51);
        oprot.writeString(temp[elem51]);
      }
      oprot.writeMapEnd();
      oprot.writeFieldEnd();
    }
