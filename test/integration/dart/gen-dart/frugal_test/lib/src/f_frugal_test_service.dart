// Autogenerated by Frugal Compiler (3.16.24)
...
abstract class FFrugalTest extends t_frugal_test.FSuperService {
  ...
  Future<t_frugal_test.Xtruct> testStruct(
      frugal.FContext ctx, t_frugal_test.Xtruct thing);

  Future<t_frugal_test.Xtruct2> testNest(
      frugal.FContext ctx, t_frugal_test.Xtruct2 thing);

  Future<Map<int, int>> testMap(frugal.FContext ctx, Map<int, int> thing);

  Future<Map<String, String>> testStringMap(
      frugal.FContext ctx, Map<String, String> thing);
  ...
  Future<Map<int, Map<int, t_frugal_test.Insanity>>> testInsanity(
      frugal.FContext ctx, t_frugal_test.Insanity argument);

  Future<t_frugal_test.Xtruct> testMulti(frugal.FContext ctx, int arg0,
      int arg1, int arg2, Map<int, String> arg3, int arg4, int arg5);

  Future testException(frugal.FContext ctx, String arg);

  Future<t_frugal_test.Xtruct> testMultiException(
      frugal.FContext ctx, String arg0, String arg1);
  ...
  Future<Uint8List> testResponseTooLarge(
      frugal.FContext ctx, Uint8List request);

  Future testOneway(frugal.FContext ctx, int millisecondsToSleep);
}

FFrugalTestClient fFrugalTestClientFactory(frugal.FServiceProvider provider,
...
class FFrugalTestClient extends t_frugal_test.FSuperServiceClient
    with disposable.Disposable
    implements FFrugalTest {
  static final logging.Logger _frugalLog = logging.Logger('FrugalTest');
  Map<String, frugal.FMethod> _methods;

  FFrugalTestClient(frugal.FServiceProvider provider,
      [List<frugal.Middleware> middleware])
    ...
    this._methods = {};
    this._methods['testVoid'] =
        frugal.FMethod(this._testVoid, 'FrugalTest', 'testVoid', combined);
    this._methods['testString'] =
        frugal.FMethod(this._testString, 'FrugalTest', 'testString', combined);
    this._methods['testBool'] =
        frugal.FMethod(this._testBool, 'FrugalTest', 'testBool', combined);
    this._methods['testByte'] =
        frugal.FMethod(this._testByte, 'FrugalTest', 'testByte', combined);
    this._methods['testI32'] =
        frugal.FMethod(this._testI32, 'FrugalTest', 'testI32', combined);
    this._methods['testI64'] =
        frugal.FMethod(this._testI64, 'FrugalTest', 'testI64', combined);
    this._methods['testDouble'] =
        frugal.FMethod(this._testDouble, 'FrugalTest', 'testDouble', combined);
    this._methods['testBinary'] =
        frugal.FMethod(this._testBinary, 'FrugalTest', 'testBinary', combined);
    this._methods['testStruct'] =
        frugal.FMethod(this._testStruct, 'FrugalTest', 'testStruct', combined);
    this._methods['testNest'] =
        frugal.FMethod(this._testNest, 'FrugalTest', 'testNest', combined);
    this._methods['testMap'] =
        frugal.FMethod(this._testMap, 'FrugalTest', 'testMap', combined);
    this._methods['testStringMap'] = frugal.FMethod(
        this._testStringMap, 'FrugalTest', 'testStringMap', combined);
    this._methods['testSet'] =
        frugal.FMethod(this._testSet, 'FrugalTest', 'testSet', combined);
    this._methods['testList'] =
        frugal.FMethod(this._testList, 'FrugalTest', 'testList', combined);
    this._methods['testEnum'] =
        frugal.FMethod(this._testEnum, 'FrugalTest', 'testEnum', combined);
    this._methods['testTypedef'] = frugal.FMethod(
        this._testTypedef, 'FrugalTest', 'testTypedef', combined);
    this._methods['testMapMap'] =
        frugal.FMethod(this._testMapMap, 'FrugalTest', 'testMapMap', combined);
    this._methods['testUppercaseMethod'] = frugal.FMethod(
        this._testUppercaseMethod,
        'FrugalTest',
        'testUppercaseMethod',
        combined);
    this._methods['testInsanity'] = frugal.FMethod(
        this._testInsanity, 'FrugalTest', 'testInsanity', combined);
    this._methods['testMulti'] =
        frugal.FMethod(this._testMulti, 'FrugalTest', 'testMulti', combined);
    this._methods['testException'] = frugal.FMethod(
        this._testException, 'FrugalTest', 'testException', combined);
    this._methods['testMultiException'] = frugal.FMethod(
        this._testMultiException, 'FrugalTest', 'testMultiException', combined);
    this._methods['testUncaughtException'] = frugal.FMethod(
        this._testUncaughtException,
        'FrugalTest',
        'testUncaughtException',
        combined);
    this._methods['testUncheckedTApplicationException'] = frugal.FMethod(
        this._testUncheckedTApplicationException,
        'FrugalTest',
        'testUncheckedTApplicationException',
        combined);
    this._methods['testRequestTooLarge'] = frugal.FMethod(
        this._testRequestTooLarge,
        'FrugalTest',
        'testRequestTooLarge',
        combined);
    this._methods['testResponseTooLarge'] = frugal.FMethod(
        this._testResponseTooLarge,
        'FrugalTest',
        'testResponseTooLarge',
        combined);
    this._methods['testOneway'] =
        frugal.FMethod(this._testOneway, 'FrugalTest', 'testOneway', combined);
  }
  ...
  Future<String> _testString(frugal.FContext ctx, String thing) async {
    ...
    throw thrift.TApplicationError(
        ...
        'testString failed: unknown result');
  }
  ...
  Future<bool> _testBool(frugal.FContext ctx, bool thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testBool failed: unknown result');
  }

  @override
  Future<int> testByte(frugal.FContext ctx, int thing) {
    return this
        ._methods['testByte']([ctx, thing])
  ...
  Future<int> _testByte(frugal.FContext ctx, int thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testByte failed: unknown result');
  }
  ...
  Future<int> _testI64(frugal.FContext ctx, int thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testI64 failed: unknown result');
  }

  @override
  Future<double> testDouble(frugal.FContext ctx, double thing) {
    return this
        ._methods['testDouble']([ctx, thing])
  ...
  Future<double> _testDouble(frugal.FContext ctx, double thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testDouble failed: unknown result');
  }

  @override
  Future<Uint8List> testBinary(frugal.FContext ctx, Uint8List thing) {
    return this
        ._methods['testBinary']([ctx, thing])
  ...
  Future<t_frugal_test.Xtruct> testStruct(
      frugal.FContext ctx, t_frugal_test.Xtruct thing) {
    return this
        ._methods['testStruct']([ctx, thing])
        .then((value) => value as t_frugal_test.Xtruct);
  }

  Future<t_frugal_test.Xtruct> _testStruct(
      frugal.FContext ctx, t_frugal_test.Xtruct thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testStruct failed: unknown result');
  }
  ...
  Future<t_frugal_test.Xtruct2> testNest(
      frugal.FContext ctx, t_frugal_test.Xtruct2 thing) {
    return this
        ._methods['testNest']([ctx, thing])
        .then((value) => value as t_frugal_test.Xtruct2);
  }

  Future<t_frugal_test.Xtruct2> _testNest(
      frugal.FContext ctx, t_frugal_test.Xtruct2 thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testNest failed: unknown result');
  }

  @override
  Future<Map<int, int>> testMap(frugal.FContext ctx, Map<int, int> thing) {
    return this
        ._methods['testMap']([ctx, thing])
        .then((value) => value as Map<int, int>);
  }

  Future<Map<int, int>> _testMap(
      frugal.FContext ctx, Map<int, int> thing) async {
  ...
  Future<Map<String, String>> testStringMap(
      frugal.FContext ctx, Map<String, String> thing) {
    return this
        ._methods['testStringMap']([ctx, thing])
        .then((value) => value as Map<String, String>);
  }

  Future<Map<String, String>> _testStringMap(
      frugal.FContext ctx, Map<String, String> thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testStringMap failed: unknown result');
  }

  @override
  Future<Set<int>> testSet(frugal.FContext ctx, Set<int> thing) {
    return this
        ._methods['testSet']([ctx, thing])
        .then((value) => value as Set<int>);
  }
  ...
  Future<Set<int>> _testSet(frugal.FContext ctx, Set<int> thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testSet failed: unknown result');
  }

  @override
  Future<List<int>> testList(frugal.FContext ctx, List<int> thing) {
    return this
        ._methods['testList']([ctx, thing])
  ...
  Future<List<int>> _testList(frugal.FContext ctx, List<int> thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testList failed: unknown result');
  }

  @override
  Future<int> testEnum(frugal.FContext ctx, int thing) {
    return this
        ._methods['testEnum']([ctx, thing])
        .then((value) => value as int);
  }
  ...
  Future<int> _testEnum(frugal.FContext ctx, int thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testEnum failed: unknown result');
  }

  @override
  Future<int> testTypedef(frugal.FContext ctx, int thing) {
    return this
        ._methods['testTypedef']([ctx, thing])
        .then((value) => value as int);
  }
  ...
  Future<int> _testTypedef(frugal.FContext ctx, int thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testTypedef failed: unknown result');
  }

  @override
  Future<Map<int, Map<int, int>>> testMapMap(frugal.FContext ctx, int hello) {
    return this
        ._methods['testMapMap']([ctx, hello])
        .then((value) => value as Map<int, Map<int, int>>);
  }

  Future<Map<int, Map<int, int>>> _testMapMap(
      frugal.FContext ctx, int hello) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testMapMap failed: unknown result');
  }

  @override
  Future<bool> testUppercaseMethod(frugal.FContext ctx, bool thing) {
    return this
        ._methods['testUppercaseMethod']([ctx, thing])
        .then((value) => value as bool);
  }
  ...
  Future<bool> _testUppercaseMethod(frugal.FContext ctx, bool thing) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testUppercaseMethod failed: unknown result');
  }
  ...
  Future<Map<int, Map<int, t_frugal_test.Insanity>>> testInsanity(
      frugal.FContext ctx, t_frugal_test.Insanity argument) {
    return this
        ._methods['testInsanity']([ctx, argument])
        .then((value) => value as Map<int, Map<int, t_frugal_test.Insanity>>);
  }

  Future<Map<int, Map<int, t_frugal_test.Insanity>>> _testInsanity(
      frugal.FContext ctx, t_frugal_test.Insanity argument) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testInsanity failed: unknown result');
  }
  ...
  Future<t_frugal_test.Xtruct> testMulti(frugal.FContext ctx, int arg0,
      int arg1, int arg2, Map<int, String> arg3, int arg4, int arg5) {
    return this
        ._methods['testMulti']([ctx, arg0, arg1, arg2, arg3, arg4, arg5])
        .then((value) => value as t_frugal_test.Xtruct);
  }

  Future<t_frugal_test.Xtruct> _testMulti(frugal.FContext ctx, int arg0,
      int arg1, int arg2, Map<int, String> arg3, int arg4, int arg5) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testMulti failed: unknown result');
  }
  ...
  Future<t_frugal_test.Xtruct> testMultiException(
      frugal.FContext ctx, String arg0, String arg1) {
    return this
        ._methods['testMultiException']([ctx, arg0, arg1])
        .then((value) => value as t_frugal_test.Xtruct);
  }

  Future<t_frugal_test.Xtruct> _testMultiException(
      frugal.FContext ctx, String arg0, String arg1) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testMultiException failed: unknown result');
  }
  ...
  Future<Uint8List> testResponseTooLarge(
      frugal.FContext ctx, Uint8List request) {
    return this
        ._methods['testResponseTooLarge']([ctx, request])
        .then((value) => value as Uint8List);
  }

  Future<Uint8List> _testResponseTooLarge(
      frugal.FContext ctx, Uint8List request) async {
    ...
    throw thrift.TApplicationError(
        frugal.FrugalTApplicationErrorType.MISSING_RESULT,
        'testResponseTooLarge failed: unknown result');
  }
...
class testString_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.STRING, 1);
  ...
  validate() {
    ...
    if (this.thing == null) {
      throw thrift.TProtocolError(thrift.TProtocolErrorType.INVALID_DATA,
          "Required field 'thing' was not present in struct testString_args");
    }
  }
}
...
class testBool_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.BOOL, 1);
...
class testByte_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.BYTE, 1);
...
class testI32_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.I32, 1);
...
class testI64_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.I64, 1);
...
class testDouble_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.DOUBLE, 1);
...
class testStruct_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.STRUCT, 1);
...
class testMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.MAP, 1);
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.thing != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeMapBegin(
          thrift.TMap(thrift.TType.I32, thrift.TType.I32, this.thing.length));
...
class testStringMap_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testStringMap_args');
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.MAP, 1);
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.thing != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeMapBegin(thrift.TMap(
          thrift.TType.STRING, thrift.TType.STRING, this.thing.length));
...
class testSet_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.SET, 1);
...
class testList_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.LIST, 1);
...
class testMapMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _HELLO_FIELD_DESC =
      thrift.TField('hello', thrift.TType.I32, 1);
...
class TestUppercaseMethod_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('TestUppercaseMethod_args');
  static final thrift.TField _THING_FIELD_DESC =
      thrift.TField('thing', thrift.TType.BOOL, 1);
...
class testInsanity_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testInsanity_args');
  static final thrift.TField _ARGUMENT_FIELD_DESC =
      thrift.TField('argument', thrift.TType.STRUCT, 1);
        ...
        case 0:
          if (field.type == thrift.TType.MAP) {
            ...
            for (int elem41 = 0; elem41 < elem35.length; ++elem41) {
              ...
              Map<int, t_frugal_test.Insanity> elem36 =
                  Map<int, t_frugal_test.Insanity>();
...
class testMulti_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _ARG0_FIELD_DESC =
      thrift.TField('arg0', thrift.TType.BYTE, 1);
  static final thrift.TField _ARG1_FIELD_DESC =
      thrift.TField('arg1', thrift.TType.I32, 2);
  static final thrift.TField _ARG2_FIELD_DESC =
      thrift.TField('arg2', thrift.TType.I64, 3);
  static final thrift.TField _ARG3_FIELD_DESC =
      thrift.TField('arg3', thrift.TType.MAP, 4);
  static final thrift.TField _ARG4_FIELD_DESC =
      thrift.TField('arg4', thrift.TType.I32, 5);
  static final thrift.TField _ARG5_FIELD_DESC =
      thrift.TField('arg5', thrift.TType.I64, 6);
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.arg3 != null) {
      ...
      oprot.writeMapBegin(
          thrift.TMap(thrift.TType.I16, thrift.TType.STRING, this.arg3.length));
...
class testException_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testException_args');
  static final thrift.TField _ARG_FIELD_DESC =
      thrift.TField('arg', thrift.TType.STRING, 1);
...
class testMultiException_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testMultiException_args');
  static final thrift.TField _ARG0_FIELD_DESC =
      thrift.TField('arg0', thrift.TType.STRING, 1);
  static final thrift.TField _ARG1_FIELD_DESC =
      thrift.TField('arg1', thrift.TType.STRING, 2);
...
class testUncaughtException_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testUncaughtException_args');
...
// ignore: camel_case_types
class testUncheckedTApplicationException_args
    extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testUncheckedTApplicationException_args');
...
// ignore: camel_case_types
class testUncheckedTApplicationException_result
    extends frugal.FGeneratedArgsResultBase {
  @override
  read(thrift.TProtocol iprot) {
    iprot.readStructBegin();
...
class testRequestTooLarge_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testRequestTooLarge_args');
  static final thrift.TField _REQUEST_FIELD_DESC =
      thrift.TField('request', thrift.TType.STRING, 1);
...
class testResponseTooLarge_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testResponseTooLarge_args');
  static final thrift.TField _REQUEST_FIELD_DESC =
      thrift.TField('request', thrift.TType.STRING, 1);
...
class testOneway_args extends frugal.FGeneratedArgsResultBase {
  ...
  static final thrift.TField _MILLISECONDS_TO_SLEEP_FIELD_DESC =
      thrift.TField('millisecondsToSleep', thrift.TType.I32, 1);
