      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.STRUCT) {
            final elem38 = t_frugal_test.Xtruct();
            this.success = elem38;
            elem38.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.STRUCT) {
            final elem40 = t_frugal_test.Xtruct2();
            this.success = elem40;
            elem40.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
...
class testMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (elem41 != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeMapBegin(thrift.TMap(thrift.TType.I32, thrift.TType.I32, elem41.length));
      for(var entry in elem41.entries) {
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            thrift.TMap elem42 = iprot.readMapBegin();
            final elem45 = <int, int>{};
            for(int elem44 = 0; elem44 < elem42.length; ++elem44) {
              int elem46 = iprot.readI32();
              int elem43 = iprot.readI32();
              elem45[elem46] = elem43;
            }
            iprot.readMapEnd();
            this.success = elem45;
          } else {
...
class testStringMap_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (elem47 != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeMapBegin(thrift.TMap(thrift.TType.STRING, thrift.TType.STRING, elem47.length));
      for(var entry in elem47.entries) {
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            thrift.TMap elem48 = iprot.readMapBegin();
            final elem51 = <String, String>{};
            for(int elem50 = 0; elem50 < elem48.length; ++elem50) {
              String elem52 = iprot.readString();
              String elem49 = iprot.readString();
              elem51[elem52] = elem49;
            }
            iprot.readMapEnd();
            this.success = elem51;
          } else {
...
class testSet_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (elem53 != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeSetBegin(thrift.TSet(thrift.TType.I32, elem53.length));
      for(var elem54 in elem53) {
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.SET) {
            thrift.TSet elem55 = iprot.readSetBegin();
            final elem58 = <int>{};
...
class testList_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (elem59 != null) {
      oprot.writeFieldBegin(_THING_FIELD_DESC);
      oprot.writeListBegin(thrift.TList(thrift.TType.I32, elem59.length));
      for(var elem60 in elem59) {
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.LIST) {
            thrift.TList elem61 = iprot.readListBegin();
            final elem64 = <int>[];
            for(int elem63 = 0; elem63 < elem61.length; ++elem63) {
              int elem62 = iprot.readI32();
              elem64.add(elem62);
            }
            iprot.readListEnd();
            this.success = elem64;
...
class testEnum_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    final elem65 = thing;
    oprot.writeFieldBegin(_THING_FIELD_DESC);
    oprot.writeI32(t_frugal_test.serializeNumberz(elem65));
    oprot.writeFieldEnd();
    oprot.writeFieldStop();
    oprot.writeStructEnd();
  }
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            ...
            final elem75 = <int, Map<int, int>>{};
            for(int elem74 = 0; elem74 < elem68.length; ++elem74) {
              int elem76 = iprot.readI32();
              thrift.TMap elem70 = iprot.readMapBegin();
              final elem69 = <int, int>{};
              for(int elem72 = 0; elem72 < elem70.length; ++elem72) {
                int elem73 = iprot.readI32();
                int elem71 = iprot.readI32();
                elem69[elem73] = elem71;
              }
              iprot.readMapEnd();
              elem75[elem76] = elem69;
            }
            iprot.readMapEnd();
            this.success = elem75;
          } else {
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.MAP) {
            thrift.TMap elem79 = iprot.readMapBegin();
            final elem87 = <int, Map<int, t_frugal_test.Insanity>>{};
            for(int elem86 = 0; elem86 < elem79.length; ++elem86) {
              int elem88 = iprot.readI64();
              thrift.TMap elem81 = iprot.readMapBegin();
              final elem80 = <int, t_frugal_test.Insanity>{};
              for(int elem84 = 0; elem84 < elem81.length; ++elem84) {
                int elem85 = t_frugal_test.deserializeNumberz(iprot.readI32());
                final elem83 = t_frugal_test.Insanity();
                t_frugal_test.Insanity elem82 = elem83;
                elem83.read(iprot);
                elem80[elem85] = elem82;
              }
              iprot.readMapEnd();
              elem87[elem88] = elem80;
            }
            iprot.readMapEnd();
            this.success = elem87;
          } else {
...
class testMulti_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (elem92 != null) {
      ...
      oprot.writeMapBegin(thrift.TMap(thrift.TType.I16, thrift.TType.STRING, elem92.length));
      for(var entry in elem92.entries) {
    ...
    oprot.writeI32(t_frugal_test.serializeNumberz(elem93));
    oprot.writeFieldEnd();
    final elem94 = arg5;
    oprot.writeFieldBegin(_ARG5_FIELD_DESC);
    oprot.writeI64(elem94);
    oprot.writeFieldEnd();
    oprot.writeFieldStop();
    oprot.writeStructEnd();
  }
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.STRUCT) {
            final elem95 = t_frugal_test.Xtruct();
            this.success = elem95;
            elem95.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 1:
          if (field.type == thrift.TType.STRUCT) {
            final elem97 = t_frugal_test.Xception();
            this.err1 = elem97;
            elem97.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
  ...
  read(thrift.TProtocol iprot) {
    ...
    for (thrift.TField field = iprot.readFieldBegin();
      ...
      switch (field.id) {
        case 0:
          if (field.type == thrift.TType.STRUCT) {
            final elem100 = t_frugal_test.Xtruct();
        ...
        case 1:
          if (field.type == thrift.TType.STRUCT) {
            final elem101 = t_frugal_test.Xception();
            this.err1 = elem101;
            elem101.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
        ...
        case 2:
          if (field.type == thrift.TType.STRUCT) {
            final elem102 = t_frugal_test.Xception2();
            this.err2 = elem102;
            elem102.read(iprot);
          } else {
            thrift.TProtocolUtil.skip(iprot, field.type);
...
class testRequestTooLarge_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    oprot.writeStructBegin(_STRUCT_DESC);
    final elem103 = request;
    if (elem103 != null) {
      oprot.writeFieldBegin(_REQUEST_FIELD_DESC);
      oprot.writeBinary(elem103);
      oprot.writeFieldEnd();
    }
    oprot.writeFieldStop();
    oprot.writeStructEnd();
...
class testResponseTooLarge_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    oprot.writeStructBegin(_STRUCT_DESC);
    final elem104 = request;
    if (elem104 != null) {
      oprot.writeFieldBegin(_REQUEST_FIELD_DESC);
      oprot.writeBinary(elem104);
      oprot.writeFieldEnd();
    }
    oprot.writeFieldStop();
    oprot.writeStructEnd();
...
class testOneway_args extends frugal.FGeneratedArgsResultBase {
  ...
  write(thrift.TProtocol oprot) {
    ...
    oprot.writeStructBegin(_STRUCT_DESC);
    final elem105 = millisecondsToSleep;
