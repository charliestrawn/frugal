...
class Insanity implements thrift.TBase {
  ...
  static final thrift.TField _USER_MAP_FIELD_DESC =
      thrift.TField('userMap', thrift.TType.MAP, 1);
  static final thrift.TField _XTRUCTS_FIELD_DESC =
      thrift.TField('xtructs', thrift.TType.LIST, 2);
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.userMap != null) {
      ...
      oprot.writeMapBegin(
          thrift.TMap(thrift.TType.I32, thrift.TType.I64, this.userMap.length));
    ...
    if (this.xtructs != null) {
      ...
      oprot.writeListBegin(
          thrift.TList(thrift.TType.STRUCT, this.xtructs.length));
