...
class Insanity implements thrift.TBase {
      ...
      switch (field.id) {
        case USERMAP:
          if (field.type == thrift.TType.MAP) {
            ...
            for(int elem14 = 0; elem14 < elem12.length; ++elem14) {
              int elem16 = t_frugal_test.deserializeNumberz(iprot.readI32());
              int elem13 = iprot.readI64();
        ...
        case XTRUCTS:
          if (field.type == thrift.TType.LIST) {
            ...
            final elem21 = <t_frugal_test.Xtruct>[];
            for(int elem20 = 0; elem20 < elem17.length; ++elem20) {
              final elem19 = t_frugal_test.Xtruct();
              t_frugal_test.Xtruct elem18 = elem19;
              elem19.read(iprot);
              elem21.add(elem18);
            }
            iprot.readListEnd();
  ...
  write(thrift.TProtocol oprot) {
    ...
    final elem22 = userMap;
    if (elem22 != null) {
      oprot.writeFieldBegin(_USER_MAP_FIELD_DESC);
      oprot.writeMapBegin(thrift.TMap(thrift.TType.I32, thrift.TType.I64, elem22.length));
      for(var entry in elem22.entries) {
    ...
    final elem23 = xtructs;
    if (elem23 != null) {
      oprot.writeFieldBegin(_XTRUCTS_FIELD_DESC);
      oprot.writeListBegin(thrift.TList(thrift.TType.STRUCT, elem23.length));
