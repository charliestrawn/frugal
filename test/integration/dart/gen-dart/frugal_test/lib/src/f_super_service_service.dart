...
FSuperServiceClient fSuperServiceClientFactory(frugal.FServiceProvider provider,
        {List<frugal.Middleware> middleware}) =>
    FSuperServiceClient(provider, middleware);

class FSuperServiceClient extends disposable.Disposable
    implements FSuperService {
  static final logging.Logger _frugalLog = logging.Logger('SuperService');
  Map<String, frugal.FMethod> _methods;

  FSuperServiceClient(frugal.FServiceProvider provider,
      [List<frugal.Middleware> middleware])
    ...
    this._methods = {};
    this._methods['testSuperClass'] = frugal.FMethod(
        this._testSuperClass, 'SuperService', 'testSuperClass', combined);
  }
...
class testSuperClass_args extends frugal.FGeneratedArgsResultBase {
  static final thrift.TStruct _STRUCT_DESC =
      thrift.TStruct('testSuperClass_args');
