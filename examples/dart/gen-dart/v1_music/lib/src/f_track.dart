...
class Track implements thrift.TBase {
  ...
  setFieldValue(int fieldID, Object value) {
    switch (fieldID) {
      case TITLE:
        this.title = value as dynamic;
        break;

      case ARTIST:
        this.artist = value as dynamic;
        break;

      case PUBLISHER:
        this.publisher = value as dynamic;
        break;

      case COMPOSER:
        this.composer = value as dynamic;
        break;
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.composer != null) {
      ...
      oprot.writeString(this.composer);
      oprot.writeFieldEnd();
    }
