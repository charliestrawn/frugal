		...
		private FAsyncCallback recvContestStart(String op, FProtocolFactory pf, ContestStartHandler handler) {
			return new FAsyncCallback() {
				public void onMessage(TTransport tr) throws TException {
					...
					java.util.List<Album> received = new ArrayList<Album>(elem23.size);
					for (int elem24 = 0; elem24 < elem23.size; ++elem24) {
						Album elem25 = new Album();
						elem25.read(iprot);
						received.add(elem25);
					}
					iprot.readListEnd();
		...
		private FAsyncCallback recvContestStart(String op, FProtocolFactory pf, ContestStartThrowableHandler handler) {
			return new FAsyncCallback() {
				public void onMessage(TTransport tr) throws TException {
					...
					java.util.List<Album> received = new ArrayList<Album>(elem26.size);
					for (int elem27 = 0; elem27 < elem26.size; ++elem27) {
						Album elem28 = new Album();
						elem28.read(iprot);
						received.add(elem28);
					}
					iprot.readListEnd();
