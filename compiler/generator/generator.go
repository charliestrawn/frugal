...
var Languages = LanguageOptions{
	"go": Options{
		...
		"omit_server_service_generation": "Set this if you want to omit generating the server code for all services. Useful only for client-only go code.",
	},
	"java": Options{
	...
	"dart": Options{
		...
		"use_vendor":         "Use specified import references for vendored includes and do not generate code for them",
		"nullsafe":           "Generate nullsafe Dart code. This option has no effect (nullsafe code is always generated). It remains for backwards compatibility.",
	},
	"py": Options{
...
// UseVendor returns whether this generator instance supports using vendored
// includes
