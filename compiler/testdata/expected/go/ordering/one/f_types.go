...
func (p *One) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *One) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *One) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "One"); err != nil {
...
func (p *One) writeField1(ctx context.Context, oprot thrift.TProtocol) error {
