...
func (p *Four) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *Four) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *Four) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "Four"); err != nil {
...
func (p *Four) writeField1(ctx context.Context, oprot thrift.TProtocol) error {
