...
class EventsPublisher {
  ...
  Future publishSomeList(frugal.FContext ctx, String user, Map<fixnum.Int64, t_variety.Event> req) {
    return this._methods?['SomeList']([ctx, user, req]);
  }

  Future _publishSomeList(frugal.FContext ctx, String user, Map<fixnum.Int64, t_variety.Event> req) async {
    ctx.addRequestHeader('_topic_user', user);
    var op = 'SomeList';
    var prefix = 'foo.$user.';
    var topic = '${prefix}Events$delimiter$op';
...
class EventsSubscriber {
  ...
  Future<frugal.FSubscription> subscribeSomeList(String user, dynamic onlist(frugal.FContext ctx, Map<fixnum.Int64, t_variety.Event> req)) async {
    var op = 'SomeList';
    var prefix = 'foo.$user.';
    var topic = '${prefix}Events$delimiter$op';
    var transport = provider.subscriberTransportFactory.getTransport();
  ...
  frugal.FAsyncCallback _recvSomeList(String op, frugal.FProtocolFactory protocolFactory, dynamic onlist(frugal.FContext ctx, Map<fixnum.Int64, t_variety.Event> req)) {
    ...
    callbackSomeList(thrift.TTransport transport) {
      ...
      Map<fixnum.Int64, t_variety.Event> req = Map<fixnum.Int64, t_variety.Event>;
