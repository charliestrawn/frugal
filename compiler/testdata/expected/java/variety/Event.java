...
public class Event implements org.apache.thrift.TBase<Event, Event._Fields>, java.io.Serializable, Cloneable, Comparable<Event> {
	...
	private static final org.apache.thrift.protocol.TField YE_S__NO_FIELD_DESC = new org.apache.thrift.protocol.TField("YES_NO", org.apache.thrift.protocol.TType.BOOL, (short)3);
	...
	private static final int __YES_NO_ISSET_ID = 1;
	...
	public Event setYES_NO(boolean YES_NO) {
		this.YES_NO = YES_NO;
		setYES_NOIsSet(true);
		return this;
	}

	public void unsetYES_NO() {
		__isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __YES_NO_ISSET_ID);
	}

	/** Returns true if field YES_NO is set (has been assigned a value) and false otherwise */
	public boolean isSetYES_NO() {
		return EncodingUtils.testBit(__isset_bitfield, __YES_NO_ISSET_ID);
	}

	public void setYES_NOIsSet(boolean value) {
		__isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __YES_NO_ISSET_ID, value);
	}
	...
	public int hashCode() {
		...
		boolean present_YES_NO = true;
		list.add(present_YES_NO);
		if (present_YES_NO)
			list.add(YES_NO);
	...
	public int compareTo(Event other) {
		...
		lastComparison = Boolean.compare(isSetYES_NO(), other.isSetYES_NO());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetYES_NO()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.YES_NO, other.YES_NO);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	private static class EventStandardScheme extends StandardScheme<Event> {
				...
				switch (schemeField.id) {
					...
					case 3: // YE_S__NO
						if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
							struct.YES_NO = iprot.readBool();
							struct.setYES_NOIsSet(true);
						} else {
							org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
						}
						break;
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, Event struct) throws org.apache.thrift.TException {
			...
			oprot.writeFieldBegin(YE_S__NO_FIELD_DESC);
			boolean elem4 = struct.YES_NO;
